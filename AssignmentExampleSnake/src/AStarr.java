...
public class AStarr {
    ...
    public AStarr(int rows, int cols, Noode initialNode, Noode finalNode, int hvCost, int diagonalCost) {
        this.hvCost = hvCost;
    ...
    public AStarr(int rows, int cols, Noode initialNode, Noode finalNode) {
